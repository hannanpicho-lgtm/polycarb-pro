    ...
    <>
      ...
      <section className="relative py-0 overflow-hidden">
        <div className="relative h-80 lg:h-96 bg-steel-900 flex items-center">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-brand-900/80 via-steel-950/60 to-steel-900" aria-hidden="true" />
          <div className="container mx-auto relative z-10">
            <div className="max-w-lg">
              <span className="tag-pill bg-brand-500 text-white mb-4 inline-block">ADVISORY SERVICE</span>
              ...
              <p className="text-white/70 text-[15px] leading-relaxed mb-7">
                A dedicated applications engineer reviews your material selection, processing conditions, and quality
                data — included with every programme. No extra cost.
              </p>
              <a
          ...
          {/* Decorative circle */}
          <div className="absolute right-8 top-1/2 -translate-y-1/2 w-72 h-72 rounded-full border-2 border-brand-500/20 hidden lg:block" aria-hidden="true" />
          <div className="absolute right-20 top-1/2 -translate-y-1/2 w-48 h-48 rounded-full border-2 border-brand-500/30 hidden lg:block" aria-hidden="true" />
        </div>
      </section>
    </>
  );
