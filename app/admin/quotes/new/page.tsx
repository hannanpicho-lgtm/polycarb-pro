      ...
      const products = form.products
        ...
        .map((p) => {
          ...
          return {
            ...
            productName: price?.name ?? p.productSlug,
            qty: p.qty || 'TBD',
            notes: p.notes,
          };
        });
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="bg-white border border-slate-200 rounded-xl p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ['Full name', 'customerName', 'text', true],
              ['Email', 'customerEmail', 'email', true],
              ['Company', 'customerCompany', 'text', false],
              ...
              <div key={String(key)}>
                ...
                <input
                  type={String(type)}
                  required={!!req}
                  value={(form as unknown as Record<string, string>)[String(key)]}
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              onClick={() =>
                setForm((f) => ({
                  ...f,
                  products: [...f.products, { productSlug: '', qty: '', notes: '' }],
                }))
              }
          ...
          {form.products.map((p, i) => (
            <div key={i} className="grid grid-cols-12 gap-2 items-end">
              <div className="col-span-7">
                ...
                <select
                  value={p.productSlug}
                  onChange={(e) => setProduct(i, 'productSlug', e.target.value)}
              ...
              <div className="col-span-3">
                ...
                <input
                  ...
                  placeholder="e.g. 500"
                  value={p.qty}
                  onChange={(e) => setProduct(i, 'qty', e.target.value)}
                  className="w-full px-2 py-2 text-xs border border-slate-200 rounded-lg focus:outline-none"
                />
              </div>
