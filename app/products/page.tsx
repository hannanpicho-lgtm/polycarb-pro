      ...
      <div className="bg-steel-950 pt-28 pb-12">
        <div className="container mx-auto">
          ...
          <p className="text-white/60 text-base max-w-2xl leading-relaxed">
            {filtered.length} grade{filtered.length !== 1 ? 's' : ''} from world-leading producers. Filter by type, industry, or brand — then request a quote or download specs.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col flex-1 p-4">
        ...
        <div className="mt-4 pt-3 border-t border-border flex items-center gap-2">
          ...
          <Button asChild size="sm" variant="outline" className="text-xs h-7 px-3">
            <Link href={`/quote?product=${product.slug}&source=products-catalog-card${compareCsv ? `&compare=${compareCsv}` : ''}`}>Quote</Link>
          </Button>
        </div>
      </div>
    </article>
