        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              ...
              <br className="hidden md:block" /> Monthly Brief
            </h2>
            <p className="text-white/60 text-sm leading-relaxed mb-8 max-w-md">
              Join 2,400+ procurement managers, OEM engineers, and fabricators who rely on our
              monthly digest for material intelligence, new inventory, and regulatory news.
            </p>
            ...
            <ul className="space-y-4">
              {benefits.map((b) => (
                <li key={b.label} className="flex items-start gap-3">
                  <span
                    className="w-1.5 h-1.5 rounded-full bg-brand-400 mt-1.5 flex-shrink-0"
                    aria-hidden="true"
                  />
                  <div>
          ...
          <div className="bg-steel-900 border border-white/10 rounded-xl p-8">
            ...
            <p className="text-[11px] text-white/30 mt-4">
              Your email is used only for this newsletter. We don't share subscriber data with third
              parties.
            </p>
          </div>
        </div>
